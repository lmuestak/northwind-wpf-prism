...
namespace Northwind.Core.Controls
{
    public class FadingContentControl : ContentControl
    {
        ...
        static FadingContentControl()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(FadingContentControl), new FrameworkPropertyMetadata(typeof(FadingContentControl)));
        }
