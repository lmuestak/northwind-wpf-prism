...
{
    //public class EditCategoryDialogViewModel : CategoryViewModel, IDialogAware
    //{
    //    public EditCategoryDialogViewModel(IContainerExtension container) : base(container)
    //    {
    //    }
